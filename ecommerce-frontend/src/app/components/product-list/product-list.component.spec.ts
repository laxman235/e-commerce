...
export class ProductListComponent {
  ...
  products = [
    { name: 'Samsung Galaxy S24', price: 79999, image: 'https://rukminim2.flixcart.com/image/312/312/xif0q/mobile/h/h/n/-original-imagufyqheqz5yzf.jpeg?q=70' },
  ...
  viewDetails(product: any) {
    ...
    // पुढे आपण Product Details Page ला route करू
  }
}